...
--CREATE UNIQUE INDEX IX_passengers_documnet ON passengers
--(
--	document_id ASC,
--	series ASC,
--	number ASC
...
ALTER TABLE passengers
	ADD CONSTRAINT DF_passengers_type DEFAULT 1 FOR [type_id]


ALTER TABLE passengers
	ADD CONSTRAINT DF_passengers_document_type DEFAULT 2 FOR document_id
